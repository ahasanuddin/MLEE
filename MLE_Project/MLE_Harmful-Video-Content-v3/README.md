...
```
  ...
  Incoming video ───► │  Sentence Transformer (all-MiniLM-L6-v2, 384-dim)  │
                      ...
                      │  Step 5: Text matching   (FAISS, weight 0.45)      │
                      │  Step 6: OCR scoring     (feature sim, weight 0.20) │
                      │  Step 7: ASR scoring     (feature sim, weight 0.20) │
                      │  Step 8: Metadata scoring (temporal, weight 0.15)   │
                      │  Step 9: Composite score (re-normalize if missing)  │
                      └──────────────────┬──────────────────────────────────┘
                                         │
                      ┌──────────────────▼──────────────────────────────────┐
